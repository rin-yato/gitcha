...
export interface VirtualizedDiffRenderableOptions
  extends RenderableOptions<VirtualizedDiffRenderable> {
  diff?: string;
  syncScroll?: boolean;
  view?: "unified" | "split";
...
export class VirtualizedDiffRenderable extends Renderable {
  ...
  private createOrUpdateCodeRenderable(
    ...
    const existingRenderable =
      side === "left" ? this.leftCodeRenderable : this.rightCodeRenderable;
